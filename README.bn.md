...
**বাংলাদেশ 🇧🇩 ও ভারত 🇮🇳-এর জন্য তৈরি।** বাংলা প্রায় ২৭ কোটি মানুষের ভাষা —
বাংলাদেশ এবং ভারতের পশ্চিমবঙ্গ, আসাম ও ত্রিপুরা। প্রতিটি সরকারি দপ্তর, এনজিও ও
প্রতিষ্ঠান রিপোর্ট তৈরি করতে গিয়ে একই দেয়ালে ধাক্কা খায়। `lipi` সেই দেয়াল ভেঙে
দেয়। এটি `bn-BD` ও `bn-IN` দুটোই বোঝে, এবং **টাকা (৳)** ও **রুপি (₹)** দুটোই সঠিক
লক্ষ/কোটি গ্রুপিং সহ ফরম্যাট করে।

> **ফ্রি ও ওপেন সোর্স (MIT)। ডাউনলোড করুন, ব্যবহার করুন, বাণিজ্যিকভাবেও —
> চিরকাল বিনামূল্যে।** কোনো লাইসেন্স ফি নেই, লক-ইন নেই। দেখুন [LICENSE](./LICENSE)।

**ভাষা পোর্ট:** পুরো ডকুমেন্ট রাইটার TypeScript-এ, তবে দুটি মূল অংশ — `.odttf`
ফন্ট এমবেডিং ও বাংলা সংখ্যা/মুদ্রা — [`ports/`](./ports)-এ Python, Ruby, PHP, C#,
Java ও Go-তে পোর্ট করা হয়েছে।
